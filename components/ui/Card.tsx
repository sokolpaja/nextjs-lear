...
const Card = () => {
	return (
		<div className="bg-red-400">
			{/* below it has box shadow bottom */}
			<div className="">{/* heading icon: z-index:10 */}</div>
			<div>{/* green bar w - 60% - z-index:-3 */}</div>
			<div>{/* circle ring z-index: -2 */}</div>
			<p>asd as</p>
			<div>
				{/* card body z-index:1 */}
				<h1>title {/* title */}</h1>
            ...
            <div className="w-6 h-6 relative bg-red-400">
